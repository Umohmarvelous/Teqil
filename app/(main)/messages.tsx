    ...
    >
      ...
      <View style={[chatStyles.header, { backgroundColor: isDark ? "#161B22" : "#fff", borderBottomColor: borderColor }]}>
        ...
        <View style={chatStyles.headerText}>
          ...
          <Text style={[chatStyles.headerRole, { color: subColor }]}>
            ...
            {conversation.participantDriverId
              ? ` · ${conversation.participantDriverId}`
              : ""}
          </Text>
        </View>
      ...
      <FlatList
            ...
            >
              ...
              <Text
                style={[
                  ...
                  { color: isMe ? "rgba(255,255,255,0.6)" : subColor },
                ]}
              >
        ...
        ListEmptyComponent={
          <View style={chatStyles.emptyChat}>
            <Ionicons name="chatbubbles-outline" size={40} color={subColor} />
            <Text style={[chatStyles.emptyChatText, { color: subColor }]}>
      ...
      >
        <TextInput
          style={[
            chatStyles.input,
            { backgroundColor: isDark ? "#0D1117" : "#F4F6FA", color: textColor },
          ]}
        ...
        <Pressable
          style={[
            chatStyles.sendBtn,
            { backgroundColor: text.trim() ? Colors.primary : (isDark ? "#2A2A2A" : "#E5E7EB") },
          ]}
          onPress={send}
          disabled={!text.trim()}
        >
...
function NewChatModal({
  ...
  const handleSearch = async () => {
    ...
    setSearching(true);
    try {
      // Search in local trip storage by driver ID or trip code
      const all = await TripsStorage.getAll();
      const trip = all.find(
        (t) =>
          t.trip_code === driverRef.toUpperCase() ||
          t.driver_id === driverRef.trim()
      );
      ...
      if (trip) {
        ...
        // Create a placeholder conversation with the entered reference
        const conv: Conversation = {
          id: generateId(),
  ...
  return (
    ...
    >
      ...
      <View style={[modalStyles.sheet, { backgroundColor: bg }]}>
        ...
        <Text style={[modalStyles.sub, { color: subColor }]}>
        ...
        >
          <Text
            style={[
              ...
              { color: driverRef.trim() ? "#fff" : subColor },
            ]}
          >
      ...
      <FlatList
          ...
          >
            ...
            <View style={styles.convText}>
              ...
              <View style={styles.convBottomRow}>
                <Text
                  style={[styles.convLastMsg, { color: subColor }]}
                  numberOfLines={1}
                >
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            <Ionicons name="chatbubbles-outline" size={48} color={subColor} />
