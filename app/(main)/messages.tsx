...
//           disabled={!text.trim()}
//         >
//           <HugeiconsIcon icon={SendIcon} size={16} color={text.trim() ? "#fff" : subColor} />
//         </Pressable>
//       </View>
//     </KeyboardAvoidingView>
//   );
...
//           <HugeiconsIcon icon={PlusIcon} size={18} color={Colors.primary} />
//         </Pressable>
//       </View>
...
//             <HugeiconsIcon icon={ChatBubbleIcon} size={48} color={subColor} />
