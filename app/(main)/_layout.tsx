...
export default function MainLayout() {
  ...
  const headerTranslateY = scrollClamp.interpolate({
    inputRange: [0, 150],
    outputRange: [0, -150],
    extrapolate: "clamp",
  });

  const bottomTranslateY = scrollClamp.interpolate({
    inputRange: [0, 150],
    outputRange: [0, 150],
    extrapolate: "clamp",
  });
      ...
      >
        ...
        <View style={{ width: SCREEN_WIDTH, flex: 1 }}>
          <DiscoverTab
            ...
            scrollY={feedScrollY} // Pass down the scrollY value
          />
        </View>
      </Animated.ScrollView>
    );
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.mainContainer}>
          ...
          {/* Absolute Top Bar (Header + Top Tabs) */}
          {activeTab === "home" && (
            <Animated.View
              style={{
                position: "absolute",
