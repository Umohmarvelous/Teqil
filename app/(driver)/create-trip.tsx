...
export default function CreateTripScreen() {
  ...
  const validate = () => {
    ...
    if (!destination.trim()) newErrors.destination = t("trip.destinationPlaceholder");
        ...
        <Animated.View style={pageStyle}>
          ...
          <View style={styles.infoBanner}>
            ...
            <Text style={styles.infoText}>
              A unique 6-character trip code will be generated. Share it with your passengers to join.
            </Text>
          </View>
          ...
          <Animated.View style={[styles.btnWrapper, btnStyle]}>
            <Pressable
              ...
              disabled={isLoading}
            >
              {!isLoading ? <Ionicons name="navigate" size={20} color="#fff" /> : null}
          ...
          <View style={{ height: 80 + Math.max(insets.bottom, 16) + (Platform.OS === "web" ? 34 : 0) }} />
        </Animated.View>
      </ScrollView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: Colors.surface, borderRadius: 20, padding: 20, shadowColor: "#000", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.22, shadowRadius: 14, elevation: 6 },
  cardMt: { marginTop: 16 },
  cardHeading: { fontFamily: "Poppins_600SemiBold", fontSize: 13, color: "#8E8E93", textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 16 },
  ...
  routeLine: { flex: 1, width: 2, backgroundColor: "rgba(52 51 51 / 0.12)", marginVertical: 4, borderRadius: 1 },
  ...
  inputRow: { flexDirection: "row", alignItems: "center", backgroundColor: Colors.borderLight, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 13, borderWidth: 1.5, borderColor: "transparent" },
  ...
  infoBanner: { flexDirection: "row", gap: 10, backgroundColor: `${Colors.primary}15`, borderRadius: 14, padding: 14, marginTop: 16, borderWidth: 1, borderColor: `${Colors.primary}30`, alignItems: "flex-start" },
  infoText: { flex: 1, fontFamily: "Poppins_400Regular", fontSize: 12, color: Colors.primaryDark, lineHeight: 18 },
  btnWrapper: { marginTop: 28 },
  submitBtn: { backgroundColor: Colors.primary, borderRadius: 18, height: 58, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, shadowColor: Colors.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.45, shadowRadius: 16, elevation: 10 },
