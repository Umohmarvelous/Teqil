...
export default function ActionTile({ icon: IconComponent, label, color, onPress }: ActionTileProps) {
  ...
  return (
    <Animated.View style={styles.actionTile}>
      ...
      >
        <View style={[styles.actionIconWrap]}>
          <View style={{ borderWidth: .5, borderColor: isDark ? Colors.textSecondary : Colors.overlay, backgroundColor: ActionTileIcon, padding: 14, borderRadius: 50, opacity: isDark ? .9 : .9 }} >
